...
def main(checkpoint, algorithm, env_name, config, num_episodes, debug):
    ...
    for eidx in range(num_episodes):
        ...
        # eps_stats['pass_attempts'][-1] = infos['player_0']["game_info"]["pass_attempts"]
        # eps_stats['num_success_pass'][-1] = infos['player_0']["game_info"]["num_success_pass"]
    ...
    print("\nasdfjaklsdfjla;j", eps_stats["rewards_total"])
    print("\nasdfjaklsdfjla;j", eps_stats["rewards_total"])
