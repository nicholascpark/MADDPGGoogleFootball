...
class RllibGFootball(MultiAgentEnv):
    ...
    def step(self, action_dict):
        ...
        for k, v in self.env.unwrapped._env._observation.items():
            ...
            game_info["shoot_attempts"] = self.num_shoot_attempts
        ...
        if d:
            game_info["num_success_pass"] = count_pass(self.ball_owned, "12") + count_pass(self.ball_owned, "21")
            # + count_pass(self.ball_owned, "10") + count_pass(self.ball_owned, "20")
